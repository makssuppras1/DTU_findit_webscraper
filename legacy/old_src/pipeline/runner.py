...
from storage import gcs_io
from extraction.hybrid_extractor import extract_pages
from sectioning import preclean, detect_hits, assemble_sections
from utils.hashing import doc_id
...
def _list_pdf_blobs(bucket: str, prefix: str) -> list[tuple[str, str]]:
    """Return list of (bucket, blob_name) for PDFs under prefix, sorted by name."""
...
def _process_one(cfg: Config, bucket: str, blob_name: str) -> tuple[bool, bool, float]:
    """Process one PDF. Return (ok, skipped, runtime_sec)."""
